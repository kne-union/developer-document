          ...
          render={({ data }) => {
              ...
              return (
                <div className={styles.detailPage}>
                  <div className={styles.noticePanel}>
                    <Empty image={Empty.PRESENTED_IMAGE_SIMPLE} description={formatMessage({ id: 'blog.detail.notExist' })} />
                  </div>
                </div>
              );
            }
            ...
            if (!isLoggedIn && !data.isPublic) {
              return (
                <div className={styles.detailPage}>
                  <div className={styles.noticePanel}>
                    <Title level={4}>{formatMessage({ id: 'blog.detail.privateArticle' })}</Title>
                    <Paragraph>{formatMessage({ id: 'blog.detail.loginToView' })}</Paragraph>
              ...
              <BlogDetailView
                ...
                headerExtra={
                  <ShareButton
                    ...
                    disabledReason={!data.isPublic ? formatMessage({ id: 'blog.detail.privateCannotShare' }) : formatMessage({ id: 'blog.detail.unpublishedCannotShare' })}
                  />
                }
                footer={
